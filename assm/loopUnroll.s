...
0000000000002043 <lin_solve>:
    ...
    208d:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    2091:	89 c2                	mov    %eax,%edx
    2093:	8b 45 f4             	mov    -0xc(%rbp),%eax
    ...
    20b3:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    20b7:	89 c2                	mov    %eax,%edx
    20b9:	8b 45 f4             	mov    -0xc(%rbp),%eax
    ...
    20dc:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    20e0:	89 c2                	mov    %eax,%edx
    20e2:	8b 45 f4             	mov    -0xc(%rbp),%eax
    ...
    2109:	8b 45 f8             	mov    -0x8(%rbp),%eax
    210c:	83 e8 01             	sub    $0x1,%eax
    210f:	0f af d0             	imul   %eax,%edx
    2112:	8b 45 f4             	mov    -0xc(%rbp),%eax
    ...
    2136:	8b 45 f8             	mov    -0x8(%rbp),%eax
    2139:	83 c0 01             	add    $0x1,%eax
    213c:	0f af d0             	imul   %eax,%edx
    213f:	8b 45 f4             	mov    -0xc(%rbp),%eax
    ...
    216c:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    2170:	89 c2                	mov    %eax,%edx
    2172:	8b 45 f4             	mov    -0xc(%rbp),%eax
